...
def createVHost():
        ...
        if (envType == "1") | (envType == "3"):
                console_h = envName.lower() + "console."
                vision_h = envName.lower() + "vision."
                edi_h = envName.lower() + "edi."
        elif envType == "2":
                console_h = envName.lower() + "consoleaut."
                vision_h = envName.lower() + "visionuat."
                edi_h = envName.lower() + "ediuat."
